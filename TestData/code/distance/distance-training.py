...
# ==========================================
FILE_INPUT = "../train_data.extxyz"          # Il tuo file contenente i frame di QE
FILE_OUTPUT_DATI = "statistiche_distanze_training.csv" # Dove salvare i risultati numerici
FILE_OUTPUT_PLOT = "plot_distanze_training.png"        # Dove salvare il grafico finale
...
plt.title("Statistiche delle Distanze Interatomiche per Frame (Dinamica QE) (traindata)", fontsize=14, pad=15)
