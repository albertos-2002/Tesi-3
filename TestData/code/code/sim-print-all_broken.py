...
PATH_CSV_VELOCITA = "dati_velocita.csv" # NUOVO CSV PER LE VELOCITÀ
...
def monitoraggio_sistema():
    ...
    # 3. Registrazione Velocità Atomiche (Convertite in Å/fs)
    ...
    # 4. Generazione Immagini Condizionata
...
# --- GRAFICI 5 E 6: VELOCITÀ VS TEMPO E VELOCITÀ VS DISTANZA ---
...
# 5. Scatter Plot: Modulo della Velocità vs Tempo
...
# 6. Scatter Plot: Modulo della Velocità vs Distanza Minima
...
print("Tutto completato! Simulazione eseguita ed i grafici delle velocità sono stati generati con successo.")
