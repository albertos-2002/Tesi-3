...
# =========================================================================
PATH_ENERGIE_GAP = "energie_predette_gap-testdata.txt"
PATH_TRAIETTORIA = "../test_data.extxyz"  # Il file con le energie vere (QE)
...
plt.title('Parity Plot: Energie GAP vs Quantum ESPRESSO (testdata)', fontsize=14)
...
plt.savefig('parity_plot_gap_vs_qe-testdata.png', dpi=300, bbox_inches='tight')
