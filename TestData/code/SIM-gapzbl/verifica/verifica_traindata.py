...
PATH_TRAIETTORIA = "../../train_data.extxyz"  # Il file che contiene i frame da controllare
PATH_OUTPUT_ENERGIE = "energie_predette_gap-traindata.txt"  # Il file dove salveremo i risultati
