...
def genera_grafico_confronto():
    ...
    file_048 = "md_gap_test-500-temp.traj"
    ...
    plt.scatter(index_48_ext, energie_48, color='blue', alpha=0.5, s=20, edgecolors='k', label='TimeStep 4.8fs')
    plt.scatter(index_048, energie_048, color='red', alpha=0.5, s=20, edgecolors='k', label='TimeStep 0.48fs')
    ...
    nome_grafico = "confronto_energie_timestep-500.png"
