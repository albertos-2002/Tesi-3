...
soap = SOAP(
    ...
    n_max=2,             # Numero di funzioni di base radiali (risoluzione radiale)
    l_max=2,             # Grado massimo delle armoniche sferiche (risoluzione angolare)
    sigma=0.5
    )
...
plt.savefig('kernel-4-qe-badsoap22.png', dpi=200, bbox_inches='tight', transparent=True)
