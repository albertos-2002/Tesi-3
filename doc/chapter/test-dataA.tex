...
\section{Potenziale con Quippy - Test 1}
...
\subsubsection{Analisi energia potenziale}
...
\begin{figure}[h]
    ...
    \captionof{schema}{Grafico del confronto tra le energie di QE e quelle di una simulazione con potenziali ML}
...
\begin{figure}[h]
    ...
    \captionof{schema}{Confronto tra i frame di simulazione tramite SOAP (n=2, l=2), dove abbiamo eliminato il primo punto (outlier anhe nei casi precedenti)}
...
\begin{figure}[h]
    ...
    \captionof{schema}{Confronto tra i frame di simulazione tramite SOAP (n=8, l=6), dove abbiamo eliminato il primo punto (outlier anhe nei casi precedenti)}
