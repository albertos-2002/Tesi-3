...
Abbiamo provato ad effettuare una simulazione di tipo NVE, sia sui dati di training che di test, dove abbiamo impostato il time step pari a $4.8$fs, come quello usato in Quantum Espresso, e lo stesso numero di step.
Data la diversa configurazione i risultati non possono essere confrontati direttamente con quelli prodotti da QE. 
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.6]{./img/andamento_nve-traindata.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.6]{./img/andamento_nve-testdata.png}
    \caption{Grafico dell'andamento temporale per i valori di energia e temperatura}
