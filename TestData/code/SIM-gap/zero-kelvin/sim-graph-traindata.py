...
PATH_TRAJ_OUTPUT = "md_gap_nve-traindata_0k.traj"
PATH_LOG_OUTPUT = "md_gap_nve-traindata_0k.log"
PATH_GRAFICO_OUTPUT = "andamento_nve-traindata_0k.png"
...
try:
    ...
    print("Inizializzazione tramite distribuzione di Maxwell-Boltzmann a 0 K...")
    MaxwellBoltzmannDistribution(atomi, temperature_K=0)
...
ax1.title.set_text('Dinamica NVE: Verifica della Conservazione - 0K - traindata')
