...
def run_md_test():
    ...
    file_potenziale = "../../results/out_potenziale_gap-500-n2-l2.xml"
    ...
    dyn = Langevin(
        ...
        friction=0.01 / units.fs, # Coefficiente di attrito per il termostato
        trajectory='md_gap_test-500-time-test.traj' # Il file dove salveremo i risultati
    )
    ...
    print("Puoi visualizzarli da terminale scrivendo: ase gui md_gap_test.traj")
