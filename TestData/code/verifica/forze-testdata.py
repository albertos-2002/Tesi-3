...
PATH_TRAIETTORIA = "../test_data.extxyz"  # Usa l'extxyz, contiene già le forze QE!
PATH_OUTPUT_FORZE = "forze_predette_gap-testdata.txt"
...
for i in range(3):
    ...
    ax.set_title(f'Parity Plot: {labels[i]} (testdata)', fontsize=12)
...
plt.savefig('parity_plot_forze-testdata.png', dpi=300, bbox_inches='tight')
plt.show()
