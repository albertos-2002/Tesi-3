...
PATH_TRAJ_OUTPUT = "md_gap_nve-testdata.traj"
PATH_LOG_OUTPUT = "md_gap_nve-testdata.log"
PATH_GRAFICO_OUTPUT = "andamento_nve-testdata.png"
...
ax1.title.set_text('Dinamica NVE: Verifica della Conservazione - testdata')
