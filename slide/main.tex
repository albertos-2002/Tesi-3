...
% --- Metadati ---
\title[Titolo Breve per il Footer]{Messa a punto di un potenziale interatomico per la simulazione della tantala amorfa tramite machine-learning}
\subtitle{Sottotitolo o Tipologia di Laurea}
\author[Cognome]{Relatore: Prof. Paolo Umari \and Laureando: Alberto Stocco}
