...
PATH_TRAJ_OUTPUT = "md_gap_nve-traindata-1fs.traj"
PATH_LOG_OUTPUT = "md_gap_nve-traindata-1fs.log"
PATH_GRAFICO_OUTPUT = "andamento_nve-traindata-1fs.png"
...
ax1.title.set_text('Dinamica NVE: Verifica della Conservazione -1fs - traindata')
