...
print("=" * 60)
print(" AVVIO SIMULAZIONE DINAMICA NVE (ANALISI COMPLETA FORZE)")
print("=" * 60)
...
# --- GRAFICO 2: FORZA NEL TEMPO (IN FUNZIONE DEL FRAME) ---
...
ax_3d.scatter(
    tempi[mask_Ta], 
    distanze_min[mask_Ta], 
    moduli_forza[mask_Ta], 
    color='royalblue', 
    alpha=0.3, 
    s=6, 
    label='Tantalo (Ta)'
...
# Regolazione angolazione della vista 3D per una visualizzazione ottimale
...
print("Tutti i grafici sono stati salvati con successo!")
