...
\section{Simulazione con metodo Montecarlo e algoritmo di Metropolis}

Discutiamo adesso i risultati ottenuti tramite la simulazione Montecarlo, vogliamo subito dire che non è presenta una versione con il potenziale ZBL, in quanto per costruzione le distanze minime tra i vari atomi non scendono sotto i valori utilizzati nella sezione precedente.

Per questa simulazione abbiamo mosso un atomo per volta, entro un cubo di lato $0.01$\AA, e abbiamo deciso di svolgere $80'000$ iterazioni, che equivalgono a $650$ Montecarlo sweep, possiamo dire in questo modo che in media un atomo ha avuto $650$ possibilità di muoversi.

In questo caso l'unico grafico di energia che ha senso guardare è quello per l'energia potenziale
...
possiamo vede che in questo caso i valori di energia rimangano stabili anche per molte iterazioni. Possiamo riconosce ancora una tendenza a diminuire, ma in questo caso abbiamo anche sezioni in cui il valore oscilla senza un preciso trend.
